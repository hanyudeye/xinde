...
*** 注释
   | Key Binding   | Description                               |
   |---------------+-------------------------------------------|
   | ~SPC m r d b~ | js文件的说明注释                          |
   | ~SPC m r d f~ | 函数注释insert JSDoc comment for function |
   | ~SPC m r d t~ | 插入tag注释 insert tag to comment         |
   | ~SPC m r d h~ | 显示tag的用法 show list of available jsdoc tags |
*** 代码导航(先要生成tag文件)
    | Key Binding   | Description                                                                              |
    |---------------+------------------------------------------------------------------------------------------|
...
** 交互
   ...
   |-------------+------------------------------------------------------------------------------------|
   | ~SPC m s b~ | 执行buffer中 send current buffer contents to the skewer REPL                       |
