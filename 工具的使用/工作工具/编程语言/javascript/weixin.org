...
*** [[index_u50.html#当前帐号信息][#]] 当前帐号信息
    :PROPERTIES:
    :CUSTOM_ID: index_u50.html#当前帐号信息
    :CLASS: calibre25
    :END:
...
*** [[index_u50.html#登录和获取用户信息][#]] 登录和获取用户信息
    :PROPERTIES:
    :CUSTOM_ID: index_u50.html#登录和获取用户信息
    :CLASS: calibre25
    :END:
