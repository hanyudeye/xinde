...
* 基本命令
** Agenda
| 代办清单简单显示 org agenda list stuck projects                           | ~SPC a o #~   |
| org occur in agenda files  在代办文件查找文件                             | ~SPC a o /~   |
| org agenda list                         代办列表                          | ~SPC a o a~   |
| org capture 抓取任务到笔记                                                | ~SPC a o c~   |
| org store agenda views 存储代办视图                                       | ~SPC a o e~   |
| org feed goto inbox                                                       | ~SPC a o f i~ |
| org feed update all                                                       | ~SPC a o f u~ |
| org cancel clock 取消时钟                                                 | ~SPC a o C c~ |
| org goto last clocked-in clock (go to specific recent clock with ~SPC u~) | ~SPC a o C g~ |
| org clock in      进入时钟                                                | ~SPC a o C i~ |
| org clock in last  最后时钟                                               | ~SPC a o C I~ |
| org jump to current clock  进入当前时钟                                   | ~SPC a o C j~ |
| org clock out           关闭时钟                                          | ~SPC a o C o~ |
| org resolve clocks                                                        | ~SPC a o C r~ |
| org store link                                                            | ~SPC a o l~   |
| org tags view                                                             | ~SPC a o m~   |
| org agenda                                                                | ~SPC a o o~   |
| org search view                                                           | ~SPC a o s~   |
| org todo list                                                             | ~SPC a o t~   |
| org-capture                                                               | ~SPC C c~     |

按日期显示  d
按周显示 w
按月显示 org-agenda  month
 ...
 * TODO 从 2016 年 7 月 24 日开始到 2016 年 12 月 1 日，每个周日的上午 10:00-12:00 进行某项任务
