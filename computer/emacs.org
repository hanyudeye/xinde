...
* c Mark      Change dired-change-
                                        from * (generic mark) to D (flagged for
Marks                marks
                                        deletion).
* ! or M-Del Mark    dired-unmark-all-
                                        Remove all marks from all files.
     Unmark All      files
* * Mark      Mark   dired-mark-
...
Symlinks             symlinks
M-} Mark       Next  dired-next-
                                        Move to the next file marked with * or D .
Marked               marked-file
M-{ Mark             dired-prev-
                                        Move to previous file marked with * or D .
Previous Marked      marked-file
% d Regexp           dired-flag-files-  Flag for deletion files that match regular
Flag                 regexp             expression.
% g Regexp           dired-mark-files-  Mark files whose contents match regular
Mark Containing      containing-regexp  expression.
% l Regexp
                     dired-downcase     Lowercase marked files.
Downcase
% R Regexp           dired-do-rename-   Rename files with filenames that match regular
Mark                 regexp             expression.
% u Regexp
                     dired-upcase       Uppercase marked files.
Upcase
